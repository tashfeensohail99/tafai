...
const PERMISSIONS: { key: string; module: string; description: string }[] = [
  ...
  { key: 'whatsapp.block', module: 'whatsapp', description: 'Block / unblock a WhatsApp contact (drops their inbound messages and calls) and archive threads' },
...
const SYSTEM_ROLES: {
  ...
  },
  {
    ...
    permissionKeys: [
      ...
      'whatsapp.reassign', 'whatsapp.block', 'whatsapp.view_team_dashboard',
  ...
  },
  {
    ...
    permissionKeys: [
      ...
      'communications.view', 'communications.send',
      'whatsapp.view_inbox', 'whatsapp.send_message', 'whatsapp.block',
    ],
  },
  {
    name: 'documentation',
