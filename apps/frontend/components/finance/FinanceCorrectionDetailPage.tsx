...
export function FinanceCorrectionDetailPage({ paymentId }: Props) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--sos-space-6)', maxWidth: 860, margin: '0 auto' }}>
      <Link href={'/finance/corrections' as Route} style={{ display: 'inline-flex', alignItems: 'center', gap: 4, color: 'var(--sos-muted)', textDecoration: 'none', fontSize: 'var(--sos-text-sm)', marginBottom: 'var(--sos-space-2)' }}>
